...
public class AddressHandler implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {
	...
	public ApiGatewayResponse addAddresses(Map<String, Object> input, Context context) {
		Response responseBody = new Response("Go Serverless v1.x! Another function executed successfully!", input);
		return ApiGatewayResponse.builder()
				.setStatusCode(200)
				.setObjectBody(responseBody)
	...
	public ApiGatewayResponse deleteAddresses(Map<String, Object> input, Context context) {
		Response responseBody = new Response("Go Serverless v1.x! Another function executed successfully!", input);
		return ApiGatewayResponse.builder()
				.setStatusCode(200)
				.setObjectBody(responseBody)
